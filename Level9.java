...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_fon_lvl9);
        ...
        previewimg.setImageResource(R.drawable.previewimgnine);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level9.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose9 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        ...
        // Кнопка продолжить - начало
        Button btncontinue9 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        ...
        img_left.setImageResource(array.images9[numLeft]); // Достаем из массива картинку
        ...
        img_right.setImageResource(array.images9[numRight]); // Достаем из массива картинку
