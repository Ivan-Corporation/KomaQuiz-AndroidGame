...
public class Level14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_fon_lvl14);
        ...
        previewimg.setImageResource(R.drawable.previewimgfourteen);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level14.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose14 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        btnclose14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Обрабатываем нажатие кнопки - начало
                try {
        ...
        // Кнопка продолжить - начало
        Button btncontinue14 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        btncontinue14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
        ...
        img_left.setImageResource(array.images14[numLeft]); // Достаем из массива картинку
        ...
        img_right.setImageResource(array.images14[numRight]); // Достаем из массива картинку
