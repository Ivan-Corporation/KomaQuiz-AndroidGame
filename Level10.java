...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.previewimgten);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level10.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose10 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        ...
        // Кнопка продолжить - начало
        Button btncontinue10 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        btncontinue10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
        ...
        // Левая
        numLeft = random.nextInt(7); // Генерируем случайное число от 0 до 9
        img_left.setImageResource(array.images10[numLeft]); // Достаем из массива картинку
        text_left.setText(array.texts10[numLeft]); // Достаём из массива текст

        // Правая
        numRight = random.nextInt(7);  // Генерируем случайное число от 0 до 9


        //Цикл с предусловием, проверяющий равенство чисел - начало
        while (numLeft==numRight) { numRight = random.nextInt(7);
        }
        //Цикл с предусловием, проверяющий равенство чисел - конец

        img_right.setImageResource(array.images10[numRight]); // Достаем из массива картинку
