...
public class Level13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.previewimgthirteen);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level13.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose13 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        btnclose13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Обрабатываем нажатие кнопки - начало
                try {
        ...
        // Кнопка продолжить - начало
        Button btncontinue13 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        btncontinue13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
        ...
        img_left.setImageResource(array.images13[numLeft]); // Достаем из массива картинку
        ...
        img_right.setImageResource(array.images13[numRight]); // Достаем из массива картинку
