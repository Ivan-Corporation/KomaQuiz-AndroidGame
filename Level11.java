...
public class Level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_fon_lvl11);
        ...
        previewimg.setImageResource(R.drawable.previewimgeleven);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level11.this,GameLevels.class); // Переход
        ...
        // Кнопка продолжить - начало
        Button btncontinue11 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        btncontinue11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
