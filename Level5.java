...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_space_lvl5);
        ...
        previewimg.setImageResource(R.drawable.previewimgfive);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level5.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose5 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        ...
        // Кнопка продолжить - начало
        Button btncontinue5 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        ...
        // Левая
        numLeft = random.nextInt(9); // Генерируем случайное число от 0 до 9
        ...
        // Правая
        numRight = random.nextInt(9);  // Генерируем случайное число от 0 до 9


        //Цикл с предусловием, проверяющий равенство чисел - начало
        while (numLeft==numRight) { numRight = random.nextInt(9);
        }
