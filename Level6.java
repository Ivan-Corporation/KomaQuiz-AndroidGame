...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_fon_lvl6);
        ...
        previewimg.setImageResource(R.drawable.previewimgsix);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level6.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose6 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        ...
        // Кнопка продолжить - начало
        Button btncontinue6 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        ...
        while (numLeft==numRight) { numRight = random.nextInt(14);
        }
