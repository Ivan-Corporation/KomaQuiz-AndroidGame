...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_fon_lvl4);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level4.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose4 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        ...
        // Кнопка продолжить - начало
        Button btncontinue4 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        ...
        // Правая
        numRight = random.nextInt(12);  // Генерируем случайное число от 0 до 9


        //Цикл с предусловием, проверяющий равенство чисел - начало
        while (numLeft==numRight) { numRight = random.nextInt(12);
        }
