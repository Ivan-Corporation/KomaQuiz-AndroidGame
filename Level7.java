...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_sport_lvl7);
        ...
        previewimg.setImageResource(R.drawable.previewimgseven);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level7.this,GameLevels.class); // Переход
        ...
        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose7 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        ...
        // Кнопка продолжить - начало
        Button btncontinue7 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        ...
        img_left.setImageResource(array.images7[numLeft]); // Достаем из массива картинку
        ...
        img_right.setImageResource(array.images7[numRight]); // Достаем из массива картинку
