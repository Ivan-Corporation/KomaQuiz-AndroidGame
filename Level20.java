...
public class Level20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_fon_lvl20);
        ...
        previewimg.setImageResource(R.drawable.previewimgtwenty);
        // Устанавливаем картинку в диалоговое окно - конец

        //Устанавливаем описание задания - начало
        TextView textdescription = (TextView)dialog.findViewById(R.id.textdescription);
                textdescription.setText(R.string.leveltwenty);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level20.this,GameLevels.class); // Переход
        ...
        textdescriptionEnd.setText(R.string.leveltwentyEnd);
        //Интересный факт - конец


        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose20 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        btnclose20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Обрабатываем нажатие кнопки - начало
                try {
        ...
        // Кнопка продолжить - начало
        Button btncontinue20 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        btncontinue20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
        ...
        img_left.setImageResource(array.images20[numLeft]); // Достаем из массива картинку
        text_left.setText(array.texts20[numLeft]); // Достаём из массива текст
        ...
        img_right.setImageResource(array.images20[numRight]); // Достаем из массива картинку
        text_right.setText(array.texts20[numRight]); // Достаём из массива текст
