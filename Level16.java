...
public class Level16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universal_fon_lvl16);
        ...
        previewimg.setImageResource(R.drawable.previewimgsixteen);
        // Устанавливаем картинку в диалоговое окно - конец

        //Устанавливаем описание задания - начало
        TextView textdescription = (TextView)dialog.findViewById(R.id.textdescription);
                textdescription.setText(R.string.levelsixteen);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent= new Intent(Level16.this,GameLevels.class); // Переход
        ...
        textdescriptionEnd.setText(R.string.levelsixteenEnd);
        //Интересный факт - конец


        // кнопка, которая закрывает диалоговое окно - начало
        TextView btnclose16 = (TextView)dialogEnd.findViewById(R.id.btnclose);
        btnclose16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Обрабатываем нажатие кнопки - начало
                try {
        ...
        // Кнопка продолжить - начало
        Button btncontinue16 = (Button)dialogEnd.findViewById(R.id.btncontinue);
        btncontinue16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    // Вернуться назад к выбору уровня - начало
                    Intent intent = new Intent(Level16.this,GameLevels.class); // Создали намерение для перехода
                    startActivity(intent); // Старт намерения
                    finish(); // Закрыть этот класс
        ...
        img_left.setImageResource(array.images16[numLeft]); // Достаем из массива картинку
        text_left.setText(array.texts16[numLeft]); // Достаём из массива текст
        ...
        img_right.setImageResource(array.images16[numRight]); // Достаем из массива картинку
        text_right.setText(array.texts16[numRight]); // Достаём из массива текст
